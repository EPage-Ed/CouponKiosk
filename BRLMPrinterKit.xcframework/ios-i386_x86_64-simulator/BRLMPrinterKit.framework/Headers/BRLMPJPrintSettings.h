...
typedef NS_ENUM(NSInteger, BRLMPrintSettingsFeedMode) {
    BRLMPrintSettingsFeedModeNoFeed,
    BRLMPrintSettingsFeedModeFixedPage,
    BRLMPrintSettingsFeedModeEndOfPage,
    BRLMPrintSettingsFeedModeEndOfPageRetract,
};
...
@property (nonatomic) BRLMPrintSettingsFeedMode feedMode;
